      ...
      <MetaData title="Ecommercee"/>
        <div className="banner">
          <div style={{position:"absolute", top:"3vmax", right:"90px",
            zIndex: 9999}}>
            <button  style={{ font: "300 1.1vmax cursive", color:"black", padding:"16px 40px", border:"0", margin:"10px",cursor:"pointer"}} onClick={()=>{history.push("/products")}}>products</button>
            <br />
            <button style={{font: "300 1.1vmax cursive" ,color:"black", padding:"16px 20px", border:"0", margin:"10px",cursor:"pointer"}} onClick={()=>{history.push("/search")}}>search products</button>
            {!isAuthenticated &&
      <button style={{ font: "300 1.1vmax cursive" ,  padding:"6px 5px", border:"0", width:"85%",cursor:"pointer"}} onClick={()=>{history.push("/login")}}>Login</button>
            }
          </div>
